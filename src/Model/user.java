...
public  class user {
    ...
    private Callback< TableColumn.CellDataFeatures<user,String>,ObservableValue<String>>
            mapCellValueFactory=new  Callback< TableColumn.CellDataFeatures<user,String>,ObservableValue<String>> (){
    ...
    public static user create(ArrayList<String> list){
    ...
    public user  putNewRow(ArrayList<String> datas){
        user p=new user();
    ...
    public user editRow(String... datas){
    ...
    public user putColData(String col,String data){
    ...
    public Callback<TableColumn.CellDataFeatures<user, String>, ObservableValue<String>> getMapCellValueFactory() {
